...
const formSchema = z.object({
  variableName: z
    ...
    .regex(/^[A-Za-z_$][A-Za-z0-9_$]*$/, {
      message:
        "Variable name must start with letters or underscore and only contains letters, numbers and underscores",
    }),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>The prompts for gemini Node</DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Varible Name</FormLabel>
                  <FormControl>
