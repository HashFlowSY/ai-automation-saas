...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      <div className="absolute -top-[1.5px] -left-[1.5px] h-[calc(100%+3px)] w-[calc(100%+3px)]">
        <style>
          {`
        @keyframes spin {
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -top-[1.5px] -left-[1.5px] h-[calc(100%+3px)] w-[calc(100%+3px)] rounded-md border-3",
          className
        )}
      />
      {children}
